...
export default function Header({
  ...
  return (
    <header
      className={`relative z-20 flex items-center justify-between border-b border-[rgba(128,86,36,0.1)] px-4 py-4 dark:border-white/10 md:px-6 md:py-5 ${className}`.trim()}
    >
      {/* LEFT LOGO BUTTON */}
      <button
        onClick={onMenuClick}
